    ...
    public JsonObject ipasV1(){
        ...
        return Json.createObjectBuilder()
                ...
                .add("ipas", Json.createArrayBuilder()
                        .add(Json.createObjectBuilder().add("id", "1").add("beer-name", "Ziiiipfer").add("brewery", "Brauerei Zipf").add("type", "Maerzen").add("alcohol", "5.0% ABV").add("user-rating", "5.00").add("country", "AT"))
