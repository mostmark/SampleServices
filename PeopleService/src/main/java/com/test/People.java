...
public class People {
    ...
    @Path("/v1/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public JsonObject getPersonV1(@PathParam("id") int id) {
    ...
    @Path("/v2/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public JsonObject getPersonV2(@PathParam("id") int id) {
